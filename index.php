            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-12 text-center mx-auto">
                        <h2 class="mb-5">7 Pillars of Muciri Village
                        </h2>
                    </div>
                        ...
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="child-empowerment.php" class="d-block">
                                ...
                                <p class="featured-block-text">
                                    <strong>Child</strong> Empowerment
                                </p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="youth-empowerment.php" class="d-block">
                                ...
                                <p class="featured-block-text">
                                    <strong>Youth</strong> Empowerment
                                </p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="entrepreneurship-development.php" class="d-block">
                                ...
                                <p class="featured-block-text">
                                    Entrepreneurship <strong>Development</strong>
                                </p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="health-empowerment.php" class="d-block">
                                ...
                                <p class="featured-block-text">
                                    <strong>Health </strong> Empowerment
                                </p>
                            </a>
                        </div>
                    </div>
